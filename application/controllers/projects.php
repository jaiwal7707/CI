...
class Projects extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['projects'] = $this->project_model->get_projects(); // IT returns array of objects that can display over view. 
	...
	{	
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$data = array(
				...
				'ProjectUserId' => $this->session->userdata('user_id'),
				'ProjectName' => $this->input->post('project_name'),
				'ProjectBody' => $this->input->post('project_body')
